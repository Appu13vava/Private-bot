...
def main():
    ...
    application.add_handler(CommandHandler("authenticate", authenticate, filters.CommandArgs()))
    application.add_handler(CommandHandler("broadcast", broadcast, filters.CommandArgs()))
    application.add_handler(CommandHandler("post_to_channels", post_to_channels, filters.CommandArgs()))
    application.add_handler(CommandHandler("create_session", create_session, filters.CommandArgs()))
